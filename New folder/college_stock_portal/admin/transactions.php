...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $pdo->commit();
        log_activity('GSSSR created stock transaction');
...
render_header('Transactions — GSSSR');
?>
<div class="d-flex justify-content-between align-items-center mb-3">
  <h1 class="h3 mb-0">Stock Transactions <span class="badge bg-warning text-dark ms-2">GSSSR</span></h1>
    ...
    <div class="modal-body">
      ...
      <div class="mb-3"><label class="form-label">Type</label>
        <select name="type" class="form-select" required>
          <option>INWARD</option><option>OUTWARD</option><option>RETURN</option><option>ADJUSTMENT</option>
        </select>
      </div>
