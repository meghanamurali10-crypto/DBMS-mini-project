...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_POST['action'] === 'save') {
        ...
        log_activity('IETW saved category ' . $_POST['name']);
        flash('success', 'Category saved.');
    }
    redirect('/IETW/categories.php');
}
...
render_header('Categories — IETW');
?>
<h1 class="h3 mb-3">Categories <span class="badge bg-info text-dark ms-2">IETW</span></h1>
<div class="row g-3">
  <div class="col-lg-4">
